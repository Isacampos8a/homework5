...
<template>
    <div class="flex justify-center gap-4 p-8">
        ...
        <button @click="prevPage" :diabled="activePage === 1" class="rounded-md bg-slate-100 p-2 font-medium text-slate-700 shadow-md">PREV</button>
        ...
        <button @click="nextPage" :diabled="activePage === pages" class="rounded-md bg-slate-100 p-2 font-medium text-slate-700 shadow-md">NEXT</button>
